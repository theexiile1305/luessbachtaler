      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36">
        <div className="max-w-2xl">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-accent-300 text-sm font-semibold uppercase tracking-widest">
              Seit 1920
            </span>
          </div>
          <h1
          ...
          {subtitle && (
            <p className="text-primary-100 text-lg md:text-xl leading-relaxed mb-8">{subtitle}</p>
          )}
