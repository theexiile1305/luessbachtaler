...
export const metadata: Metadata = createMetadata({
  title: 'Kontakt',
  description:
    "Nehmen Sie Kontakt auf mit dem GTEV D'Lüßbachtaler Höhenrain – per E-Mail, Post oder über unser Kontaktformular.",
  path: '/kontakt',
})
  ...
  return (
    <>
      <Hero
        variant="page"
        title="Kontakt"
        subtitle="Haben Sie Fragen, möchten Sie Mitglied werden oder uns einfach Hallo sagen? Wir freuen uns auf Ihre Nachricht!"
      />
              ...
              <div className="mt-8 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-text-muted text-sm leading-relaxed">
                    Die einfachste Möglichkeit, uns persönlich kennenzulernen: Kommen Sie einfach zu
                    einem unserer monatlichen Vereinsabende vorbei.{' '}
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <a
                      ...
                      className="text-primary-700 hover:text-primary-600 text-sm font-medium"
                    >
                      Instagram
                    </a>
                    <a
                ...
                <div>
                  ...
                  <p className="text-text-muted text-sm mb-2">
                    Höhenrain liegt in der Gemeinde Berg am Starnberger See, ca. 35 km südlich von
                    München.
                  </p>
                  <a
                    href="https://maps.google.com/?q=Attenhauser+Str.+22,+82335+Berg"
                    target="_blank"
                    rel="noopener noreferrer"
