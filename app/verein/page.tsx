  ...
  return (
    <>
            ...
            <div>
              ...
              <div className="mt-6 space-y-5 text-text-muted leading-relaxed">
                <p>
                  ...
                  - ein Verein mit tiefen Wurzeln und lebendigem Brauchtum im Herzen der Gemeinde
                  Berg am Starnberger See.
                </p>
                <p>
                  Unser Name leitet sich vom Lüßbach ab, der durch unsere Heimat Höhenrain fließt.
                  Seit unserer Wiedergründung im Jahr 1982 mit 196 Gründungsmitgliedern wächst unser
                  Verein stetig und verbindet Generationen durch gemeinsame Werte: Tracht, Tradition
                  und Heimatliebe.
                </p>
                <p>
                  Gleichzeitig mit dem Verein wurde die{' '}
                  <strong className="text-text">Lüßbacher Blasmusik</strong> gegründet, die seither
                  ein fester Bestandteil unseres Vereinslebens ist und unsere Veranstaltungen
              ...
              <div className="bg-primary-50 rounded-lg p-6 border border-primary-100">
                ...
                <ul className="space-y-3 text-text-muted text-sm">
                  <li className="flex gap-3">
                    ...
                    <span>
                      <strong className="text-text">Schuhplattler</strong> in der Erwachsenen-,
                  ...
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">→</span>
                    <span>
                      <strong className="text-text">Vereinsabende</strong> - monatliche Treffen mit
                      Proben und Geselligkeit
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">→</span>
                    <span>
                      <strong className="text-text">Theatergruppe</strong> - jährliche Aufführungen
                  ...
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">→</span>
                    <span>
                      <strong className="text-text">Lüßbacher Blasmusik</strong> - Musik bei Festen
                      und Auftritten
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">→</span>
                    <span>
                      <strong className="text-text">Vereinsausflüge</strong> und Jahresfeste
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-16 bg-surface-warm">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading as="h2" title="Mehr erfahren" centered />
