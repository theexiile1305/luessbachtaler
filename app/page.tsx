...
const activities = [
  {
    ...
    title: 'Schuhplattler',
    description:
      'Unsere Tänzerinnen und Tänzer pflegen den traditionellen Schuhplattler – von der Kinder- bis zur Erwachsenengruppe.',
    href: '/jugend',
  },
  {
    icon: '🎭',
    title: 'Theater',
    description:
      'Jedes Jahr bringt unsere Theatergruppe ein neues Stück auf die Bühne – Volkstheater mit Herzblut und Humor.',
    href: '/theater',
  },
  {
    icon: '🎶',
    title: 'Blasmusik',
    description:
      'Die Lüßbacher Blasmusik umrahmt unsere Feste und Veranstaltungen mit traditioneller bayerischer Musik.',
    href: '/verein',
  },
  {
    icon: '👨‍👩‍👧‍👦',
    title: 'Gemeinschaft',
    description:
      'Monatliche Vereinsabende, Ausflüge und Feste – bei uns steht das Miteinander an erster Stelle.',
...
const organizationJsonLd = {
  ...
  description:
    'Traditioneller Trachtenverein in Höhenrain (Gemeinde Berg, Bayern) mit Schuhplattler, Theater und Blasmusik seit 1920.',
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <SectionHeading
                as="h2"
                title="Der Verein"
                subtitle="Ein Stück lebendiger bayerischer Tradition mitten in Höhenrain."
              />
              <div className="mt-6 space-y-4 text-text-muted leading-relaxed">
                <p>
                  Gegründet 1920 als <em>Würmseelust Höhenrain</em> und 1982 wiedergegründet als{' '}
                  <em>D&apos;Lüßbachtaler</em>, vereinen wir Mitglieder aller Generationen unter dem
                  gemeinsamen Ziel: bayerische Tracht, Schuhplattler und Brauchtum lebendig zu
                  halten.
                </p>
                <p>
                  Ob auf Vereinsabenden, beim Jahresfest oder bei öffentlichen Auftritten – unsere
                  Gemeinschaft wächst mit jeder gemeinsamen Stunde zusammen.
                </p>
              </div>
              <div className="mt-8 flex gap-4">
                ...
                <Button href="/verein/mitglied-werden" variant="ghost">
                  Mitglied werden
                </Button>
              </div>
            </div>
      ...
      <section className="py-20 bg-surface-warm" aria-labelledby="activities-heading">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subtitle="Tracht, Musik, Theater und Gemeinschaft – das sind die vier Säulen unseres Vereinslebens."
            centered
          />
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
              <SectionHeading
                ...
                subtitle="Besuchen Sie uns – wir freuen uns auf Sie!"
              />
              <Button href="/veranstaltungen" variant="ghost" size="sm" className="shrink-0">
                Alle Termine →
              </Button>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <SectionHeading
                as="h2"
                title="Volkstheater mit Herzblut"
                subtitle="Unsere Theatergruppe begeistert jedes Jahr mit einem neuen Stück – Volkstheater, das unterhält, lacht und berührt."
              />
              <div className="mt-8">
                <Button href="/theater" variant="secondary" size="md">
                  Zur Theatergruppe
                </Button>
              </div>
            </div>
            <div className="bg-primary-600 rounded-lg p-10 text-center" aria-hidden="true">
              ...
              <p className="font-serif text-xl text-primary-200 italic">
                &ldquo;Lachen ist die beste Medizin.&rdquo;
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-primary-50 rounded-lg p-10 text-center" aria-hidden="true">
              <div className="text-7xl mb-4">👟</div>
              <p className="font-serif text-xl text-primary-700 italic">
            ...
            <div>
              <SectionHeading
                as="h2"
                title="Jugend und Nachwuchs"
                subtitle="In unserer Kinder- und Jugend-Plattelgruppe lernen die Jüngsten den Schuhplattler – mit Spaß und Begeisterung."
              />
              <div className="mt-8">
                <Button href="/jugend" variant="primary" size="md">
                  Zur Jugendgruppe
                </Button>
              </div>
            </div>
      ...
      <section className="py-20 bg-accent-500" aria-labelledby="join-heading">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SectionHeading
            ...
            subtitle="Ob jung oder alt – bei den Lüßbachtalern sind alle herzlich willkommen. Treten Sie unserem Verein bei und erleben Sie Gemeinschaft, Tradition und jede Menge Freude."
            centered
            ornament={false}
          />
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Button href="/verein/mitglied-werden" variant="primary" size="lg">
            ...
            <Button
              ...
              variant="ghost"
              size="lg"
              className="border-primary-800 text-primary-900 hover:bg-primary-600/10"
            >
              Kontakt aufnehmen
            </Button>
          </div>
