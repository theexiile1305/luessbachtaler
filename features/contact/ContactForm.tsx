...
export function ContactForm() {
  ...
  return (
    <form action={formAction} noValidate className="space-y-5">
      ...
      {state.error && (
        <div role="alert" className="rounded bg-red-50 border border-red-200 px-4 py-3 text-sm text-red-700">
          {state.error}
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          <label htmlFor="contact-name" className="block text-sm font-medium text-text mb-1.5">
            Name <span className="text-red-600" aria-label="Pflichtfeld">*</span>
          </label>
          <input
            id="contact-name"
            name="name"
        ...
        <div>
          <label htmlFor="contact-email" className="block text-sm font-medium text-text mb-1.5">
            E-Mail <span className="text-red-600" aria-label="Pflichtfeld">*</span>
          </label>
          <input
            id="contact-email"
            name="email"
      ...
      <div>
        <label htmlFor="contact-message" className="block text-sm font-medium text-text mb-1.5">
          Nachricht <span className="text-red-600" aria-label="Pflichtfeld">*</span>
        </label>
        <textarea
          id="contact-message"
          name="message"
